    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    ...
                    using (var db = new SiteDbContext())
                    {
                        ...
                        ifAccountBan = db.AspNetUserBan
                            .Any(r => r.UserId.Equals(user.Id));
                    }

                    if (ifAccountBan)
                    {
                        ModelState.AddModelError("", "Compte banni.");
                        this.LogOff();
                        return View(model);
                    }
                    else
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, RegistrationDate = DateTime.Now, LastLoginDate = DateTime.Now };
